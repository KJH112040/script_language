...
# 문제 6개
# 6월 12일
# 자료에 있는 코드들 그대로 활용하는 문제 주
# 우선 순위 큐를 이용한 그리디 (순회 강연 유사 문제)
# 크루스칼 알고리즘으로 MST를 구성하는 알고리즘 코드를 써야하는 문제(문제를 위해 조건 변형 필요, union-find 구조)
# 위상 정렬 활용
# 소수를 판정할 때 에라토스테네스의 채 이용
# two pointer 활용
# 누적합(prefix sum) 이용
# 교재에 나와 있는 코드 그대로 활용해 문제에 적용
#==================================================================